...
local MainSection = Main:NewSection("Toggle AutoFarm")


MainSection:NewToggle("Toggle", "Toggle your autofarm", function(state)
    if state then
        repeat
    wait()
until game:IsLoaded()
...
local Credit2Section = Credits:NewSection("Thanks to Kavo Library for making this possible :D")
